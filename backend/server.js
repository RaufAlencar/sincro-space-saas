// server.js - Versão FINAL (Retorno ao Service Account)
// O Google informou que API Keys não são suportadas.
// Voltamos ao método original, que agora funcionará com as correções de deploy.
...
const { VertexAI } = require('@google-cloud/vertexai'); // <-- VOLTAMOS PARA A BIBLIOTECA ORIGINAL
...
// <-- INICIALIZAÇÃO CORRETA COM SERVICE ACCOUNT
...
// <-- FUNÇÃO getAIResponse PARA SERVICE ACCOUNT
